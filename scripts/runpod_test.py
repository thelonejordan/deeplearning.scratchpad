...
def run_tests_on_pod(host, port, commit_sha, test_commands, ssh_key_path, hf_token=None):
...
def main():
    ...
    try:
        ...
        exit_code = run_tests_on_pod(host, port, commit_sha, test_commands, ssh_key_path, hf_token)
        sys.exit(exit_code)
    except Exception as e:
